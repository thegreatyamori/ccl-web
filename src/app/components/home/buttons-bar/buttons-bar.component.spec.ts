...
describe('ButtonsBarComponent', () => {
  ...
  describe(':', () => {
    ...
    it('should have as navCalendarImage "card-calendar.jpg"', () => {
      expect(component.navCalendarImage).toEqual('assets/img/home/card-calendar.jpg');
    });

    it('should have as navDonationsImage "card-donations.jpg"', () => {
      expect(component.navDonationsImage).toEqual('assets/img/home/card-donations.jpg');
    });
